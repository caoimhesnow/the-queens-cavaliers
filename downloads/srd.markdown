...
**Automatic Competency:** Player characters are automatically Competent with the Interaction skill.
...
Magicks work in very subtle ways: brewing draughts, weaving charms into clothing, and reading portents. Most characters
...
Before a fight breaks out, the Gamemaster should define these Areas and the
...
opponents, of course, can challenge a group of player characters as major
villains or powerful allies\!

::::::::::::::::::::::::::::::::::::::: toolbox :::::::::::::::::::::::::::::::::::::::
###### For the MJ: Using Opponents
...
player characters, use the rule for assisting to have them grant additional dice
...
characteristics:
  ...
  - Yield Limit equal to 3 plus the maximum value of their Competency die
...
few exceptions. Characteristics of major characters include:
  ...
  - Competency die of D8 or higher, and corresponding experience points spent
  - Wealth pool based on 2 Social Rank dice plus Competency die 
  - Yield limit equal to 6 plus the maximum value of their Competency die
  ...
  - Three Style Maneuvers, plus additional if bought with experience points
...
an Italian Sailor by changing her Passions.

Some of the ways you can customize the opponents listed in
this chapter include:

  - Increasing the size of the Competency die (from D6 to D8, for example)
...
- **Style Maneuvers:** Social Reliability (spend 1 to reroll Interaction), Manners Count (when speaking to someone of at least Artisan rank, spend
